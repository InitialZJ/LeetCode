...
PriorityQueue::PriorityQueue() { nums = vector<int>(); }

PriorityQueue::~PriorityQueue() {}

bool PriorityQueue::empty() { return size() == 0; }

int PriorityQueue::size() { return nums.size(); }
...
int PriorityQueue::left(int i) { return i * 2 + 1; }

int PriorityQueue::parent(int i) { return (i - 1) >> 1; }

int PriorityQueue::top() { return nums[0]; }
